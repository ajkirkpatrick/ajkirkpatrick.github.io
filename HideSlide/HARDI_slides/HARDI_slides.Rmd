---
title: "Heat Pump Demand Research"
subtitle: "In four slides"
author: "Justin Kirkpatrick, Soren Anderson"
...
### The key to answering these questions is understanding how consumers weigh their current fuel prices in deciding to switch fuels.
...
- We can measure the amount of switching taking place in a market over time using the *quantities and fuel types of heaters and air conditioners shipped to each market over time.*
...
### Answering our research questions also:
- Provides insight into consumer demand under different electricity prices
  - And under different subsidy schemes
  
- Shows whether or not propane-to-heat pump switching is likely to increase significantly when propane prices increase or become more volatile
  - Helpful for demand forecasting, planning

- We are open to other overlapping benefits, just ask.
...
### Optimal data
- Optimal data would be market x quarter sales (qty, price) by type
  - We know national level monthly [shipments](#AnnualShipments), but market-level opens the door to understanding role of electricity and propane prices.

- We understand stakeholder/member concerns and can work well with less-than-optimal data.
...
.font50[.center[Author's calculations from RECS 2009 and 2015]]
...
```
.font50[.center[Author's calculations AHRI public data]]
